            ...
            steps{
                script{                    
                    withAWS(credentials: 'my-cba-aws-credential', region: 'eu-west-2') {
                        ...
                        s3Upload(pathStyleAccessEnabled: true, payloadSigningEnabled: true, file:'maven_project/target/my-app-1.0-SNAPSHOT.jar', bucket:'buildclass3lab1', path:'ci-demo/javaapp/myapp.jar')
                    }
                }
            }
        }
